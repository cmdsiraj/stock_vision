...
function StockChartRow({ data, onClickFunction, sign }) {
  ...
  return (
    <>
      <div
        className="flex flex-row border-solid border-2 p-1 items-center bg-gray-700 text-white text-sm hover:bg-gray-600 active:bg-gray-800 hover:cursor-pointer active:cursor-wait"
