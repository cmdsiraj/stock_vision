    ...
    <>
      ...
      {/* <div className="relative">
        <img
          src={banner}
          alt="Stock-Vision"
          className="2xl:basis-1/3 xl:basis-1/3 lg:basis-1/3 md:basis-1/3 basis-full:sm-basis-left"
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <div className="opacity-80 flex flex-row gap-20 grid-cols-2 text-white font-mono-bold tracking-wide mb-4 2xl:text-3xl xl:text-3xl lg:text-3xl md:text-3xl sm:text-3xl">
            <button
              onClick={() => navigate("/stockPrediction")}
              className="rounded-full  px-6 py-3 hover:bg-gray-800 bg-gray-900 transform hover:scale-110"
            >
              Predict future prices
            </button>

            <button
              onClick={() => navigate("/livePrices")}
              className="rounded-full px-6 py-3 hover:bg-gray-800 bg-gray-900 transform hover:scale-110"
            >
              live stock prices
            </button>
      ...
      <div className="flex xl:flex-row lg:flex-row md:flex-row flex-col sm:flex-left">
        <div
          ref={liveRef}
          className="2xl:basis-2/3 xl:basis-2/3 lg:basis-2/3 md:basis-1/3 overflow-scroll sm:overflow-left"
        >
          <StockTable />
        </div>
