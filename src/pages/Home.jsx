    ...
    <>
        <div className="relative">
            ...
            <div className=" backdrop-blur-sm absolute inset-0 flex flex-col items-center justify-center">
                ...
                <h2 className="text-white  font-mono-bold tracking-wide mb-4 2xl:text-3xl xl:text-3xl lg:text-3xl md:text-3xl sm:text-3xl ">Predict future prices, live stock prices</h2>
            </div>
        </div>
